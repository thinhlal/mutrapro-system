package com.mutrapro.file_service.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity, 
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/files/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/files").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.PUT, "/files/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.DELETE, "/files/**").hasRole("ADMIN")
