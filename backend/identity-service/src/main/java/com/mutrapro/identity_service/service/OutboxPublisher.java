...
/**
 * Outbox Publisher cho identity-service
...
public class OutboxPublisher extends BaseOutboxPublisher<OutboxEvent> {
    ...
    private final com.mutrapro.identity_service.repository.OutboxEventRepository jpaOutboxEventRepository;

    /**
     * Map event_type → Kafka topic name
     * Có thể config từ application.yml hoặc hardcode
     */
    private final Map<String, String> eventTypeToTopicMap;

    public OutboxPublisher(KafkaTemplate<String, Object> kafkaTemplate,
                          com.mutrapro.identity_service.repository.OutboxEventRepository jpaOutboxEventRepository,
