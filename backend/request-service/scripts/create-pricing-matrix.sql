...
SELECT gen_random_uuid(), 'transcription', 'per_minute', 5000.00, 'VND', 'Giá ký âm theo phút', true, 'SYSTEM', NOW(), 'SYSTEM', NOW()
...
INSERT INTO pricing_matrix (pricing_id, service_type, unit_type, base_price, currency, description, is_active, created_by, created_at, updated_by, updated_at)
SELECT gen_random_uuid(), 'arrangement_with_recording', 'per_song', 2000000.00, 'VND', 'Giá phối khí + thu âm theo bài (chưa bao gồm phí ca sĩ)', true, 'SYSTEM', NOW(), 'SYSTEM', NOW()
