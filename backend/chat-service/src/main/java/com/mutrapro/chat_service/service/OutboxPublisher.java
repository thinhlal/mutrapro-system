...
/**
 * Outbox Publisher cho chat-service
...
public class OutboxPublisher extends BaseOutboxPublisher<OutboxEvent> {
    ...
    private final com.mutrapro.chat_service.repository.OutboxEventRepository jpaOutboxEventRepository;
    ...
    public OutboxPublisher(KafkaTemplate<String, Object> kafkaTemplate,
                          com.mutrapro.chat_service.repository.OutboxEventRepository jpaOutboxEventRepository,
