...
import styles from './AdminMilestonesPage.module.css';
...
const AdminMilestonesPage = () => {
  ...
  const handleAssign = slot => {
    navigate(
      `/admin/milestone-assignments/${slot.contractId}/new?milestoneId=${slot.milestoneId}`
    );
  };

  const handleViewDetail = slot => {
    navigate(
      `/admin/milestone-assignments/${slot.contractId}/milestone/${slot.milestoneId}`
    );
  };
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const handleBookStudio = slot => {
          navigate(
            `/admin/studio-booking/${slot.contractId}/${slot.milestoneId}`
          );
        };
