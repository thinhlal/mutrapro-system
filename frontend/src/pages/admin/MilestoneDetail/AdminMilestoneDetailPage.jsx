...
import styles from './AdminMilestoneDetailPage.module.css';
...
const AdminMilestoneDetailPage = () => {
        ...
        <div className={styles.headerInfo}>
          ...
          <Space>
            ...
            <Button
              onClick={() =>
                navigate(
                  `/admin/task-progress?contractId=${contractId}&milestoneId=${milestoneId}`
                )
              }
            >
              Open Task Progress
            ...
            {canShowAssignButton && (
              <Button
                ...
                onClick={() =>
                  navigate(
                    `/admin/milestone-assignments/${contractId}/new?milestoneId=${milestoneId}`
                  )
                }
              >
                Assign Task
            ...
            {canShowBookStudioButton && (
              <Button
                ...
                onClick={() =>
                  navigate(
                    `/admin/studio-booking/${contractId}/${milestoneId}`
                  )
                }
          ...
          <Card
            ...
            extra={
              <Button
                ...
                icon={<EyeOutlined />}
                onClick={() =>
                  navigate(`/admin/service-requests/${request.requestId}`)
                }
              >
                View full request
              </Button>
            ...
            extra={
              bookingData.bookingId && (
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      `/admin/studio-bookings/${bookingData.bookingId}`
                    )
                  }
                >
                  View full booking
                  ...
                  render: (_, record) => (
                    <Space size="small">
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/tasks/${contractId}/${record.assignmentId}`
                          )
                        }
                      >
                        View
                      ...
                      {record.hasIssue && (
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/task-progress?contractId=${contractId}&milestoneId=${milestoneId}&highlightTaskId=${record.assignmentId}`
                            )
                          }
                        >
                          Handle Issue
...
export default AdminMilestoneDetailPage;
