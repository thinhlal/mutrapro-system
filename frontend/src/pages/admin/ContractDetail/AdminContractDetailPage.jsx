...
import styles from './AdminContractDetailPage.module.css';
                          ...
                          <>
                            ...
                            {bookingData.participants.map(
                              (participant, index) => {
                                ...
                                const skillLabel = participant.skillName
                                  ? ` (${participant.skillName})`
                                  : '';

                                const totalFee =
                                  typeof participant.participantFee === 'number'
                                    ? participant.participantFee
                                    : participant.participantFee
                                      ? Number(participant.participantFee)
                                      : 0;
      ...
      <Modal
        ...
        onOk={async () => {
          ...
          try {
            ...
            toast.error(err?.message || 'Không thể bắt đầu contract', { duration: 5000, position: 'top-center' });
          } finally {
            setStartingWork(false);
          }
        }}
