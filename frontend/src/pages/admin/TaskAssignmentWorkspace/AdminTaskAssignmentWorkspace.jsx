...
import styles from './AdminTaskAssignmentWorkspace.module.css';
...
export default function AdminTaskAssignmentWorkspace() {
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      if (response?.status === 'success') {
        ...
        navigate('/admin/milestone-assignments');
      }
    } catch (error) {
    ...
    return (
      <div className={styles.loadingWrapper}>
        ...
        <Button
          ...
          style={{ marginTop: 16 }}
          onClick={() => navigate('/admin/milestone-assignments')}
        >
          Back to list
        </Button>
      </div>
