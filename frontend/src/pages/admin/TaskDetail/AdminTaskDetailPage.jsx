...
import styles from './AdminTaskDetailPage.module.css';
  ...
  const handleCancelTaskByManager = async () => {
    ...
    try {
      ...
      if (response?.status === 'success') {
        ...
        navigate(
          `/admin/milestone-assignments/${contractId}/new?milestoneId=${task.milestoneId}&taskType=${task.taskType}&excludeSpecialistId=${task.specialistId}`
        );
      }
    } catch (error) {
          ...
          <Space>
            ...
            {task.milestoneId && (
              <Button
                onClick={() =>
                  navigate(
                    `/admin/milestone-assignments/${contractId}/milestone/${task.milestoneId}`
                  )
                }
              >
                View Milestone
                  ...
                  <Descriptions.Item label="Booking ID">
                    <Space>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/studio-bookings/${studioBooking.bookingId}`
                          )
                        }
                      >
                        View Details
