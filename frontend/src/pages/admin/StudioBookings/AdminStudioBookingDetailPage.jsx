...
import styles from './AdminStudioBookingDetailPage.module.css';
...
const AdminStudioBookingDetailPage = () => {
  ...
  const handleViewMilestone = (contractId, milestoneId) => {
    if (contractId && milestoneId) {
      navigate(
        `/admin/milestone-assignments/${contractId}/milestone/${milestoneId}`
      );
    }
  };
  ...
  const handleViewTask = (contractId, assignmentId) => {
    if (contractId && assignmentId) {
      navigate(`/admin/tasks/${contractId}/${assignmentId}`);
    }
  };
...
export default AdminStudioBookingDetailPage;
