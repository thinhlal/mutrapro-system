...
import styles from './AdminStudioBookingsManagement.module.css';
...
const AdminStudioBookingsManagement = () => {
  ...
  const handleViewBookingDetail = bookingId => {
    navigate(`/admin/studio-bookings/${bookingId}`);
  };
...
export default AdminStudioBookingsManagement;
