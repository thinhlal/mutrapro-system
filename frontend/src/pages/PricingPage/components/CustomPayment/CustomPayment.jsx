            ...
            <Row className="g-4 g-lg-5">
              <Col lg={6} className={styles.col}>
                ...
                <p className={styles.text}>
                  If you can’t commit or pay for the full project at once, let
                  our team know and we will find the best payment solution for
                  you.
                </p>
                <br />
                <p className={styles.text}>
                  Our options include: 50–50% payments, PayPal 3 or 4
                  installments options, dividing the project in batches that you
                  can afford, and others.
                </p>
              </Col>
              ...
              <Col lg={6} className={`${styles.col} ${styles.rightCol}`}>
                ...
                <br />
                <p className={styles.text}>
                  Tell our team to get started with just a portion of the song
                  or the project, and let’s take things at a pace that works for
                  you.
                </p>
              </Col>
            </Row>
