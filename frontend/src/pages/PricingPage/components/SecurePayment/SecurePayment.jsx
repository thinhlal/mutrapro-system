      ...
      <Container className={styles.container}>
        ...
        <Row className={`g-4 g-lg-5 ${styles.grid}`}>
          ...
          <Col lg={4} className={styles.item}>
            <img className={styles.iconLogos} src={Onlyverified} alt="Verified payment methods logos" />
          ...
          {/* Middle */}
          <Col lg={4} className={styles.item}>
            <img className={styles.icon} src={Dataprotection} alt="Data protection" />
            <h3 className={styles.itemTitle}>Data protection</h3>
            <p className={styles.desc}>
              All payment gateways are safe and your data is encrypted and private.
            </p>
          </Col>

          {/* Right */}
          <Col lg={4} className={styles.item}>
            <img className={styles.icon} src={Customersupport} alt="Customer support" />
