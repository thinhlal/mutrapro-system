...
const ITEMS = [
  {
    ...
    desc: (
      <>
        Get <strong>special deals</strong> as a returning customer
      </>
    ),
  ...
  },
  {
    ...
    desc: (
      <>
        <strong>B2B</strong> custom pricing and solutions
      </>
    ),
  ...
  },
  {
    ...
    desc: (
      <>
        Explore <strong>partnership</strong> options with us
      </>
    ),
