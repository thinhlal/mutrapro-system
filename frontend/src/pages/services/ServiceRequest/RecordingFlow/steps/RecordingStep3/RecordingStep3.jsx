...
export default function RecordingStep3({ data, onComplete, onSkip }) {
  ...
  const [wantsInstrumentalists, setWantsInstrumentalists] = useState(
    data?.wantsInstrumentalists !== undefined ? data.wantsInstrumentalists : null
  );
  ...
  const handleSelectInstrumentalists = () => {
    ...
    sessionStorage.setItem('recordingFlowInstrumentalistCallback', JSON.stringify(callbackData));
          ...
          <div className={styles.radioContainer}>
            <Radio.Button value={true} className={styles.radioButton}>
              <div className={styles.radioContent}>
                <div>
                  <div className={styles.radioTitle}>Yes, I want to select instrumentalists</div>
                  <div className={styles.radioDescription}>
                    Choose from our professional instrumentalists by instrument type
                  </div>
                </div>
              </div>
            </Radio.Button>
            ...
            <Radio.Button value={false} className={styles.radioButton}>
              <div className={styles.radioContent}>
                <div>
                  <div className={styles.radioTitle}>No, I'll play myself or bring my own instrumentalists</div>
                  <div className={styles.radioDescription}>
