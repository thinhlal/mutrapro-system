...
import { Input, Spin, Empty, Badge, Tag, Select, Button } from 'antd';
import { SearchOutlined, LockOutlined, HomeOutlined } from '@ant-design/icons';
import { useChatRooms } from '../../hooks/useChat';
import ChatConversationPage from '../../pages/chat/ChatConversation/ChatConversationPage';
import Header from '../../components/common/Header/Header';
import styles from './AdminChatLayout.module.css';

const { Option } = Select;

/**
 * Admin Chat Layout - Facebook Messenger Style
 * Left sidebar: List of chat rooms
 * Right content: Selected conversation
 * Full-screen layout with Header (separate from AdminLayout)
 */
const AdminChatLayout = () => {
  ...
  const handleRoomClick = room => {
    navigate(`/admin/chat/${room.roomId}`);
  };
  ...
  return (
    <div className={styles.adminChatLayoutWrapper}>
